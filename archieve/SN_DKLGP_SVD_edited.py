...
from utils.models import FeatureExtractor, FeatureExtractorWithoutSN, DKLGPModel, FeatureExtractorRes
from utils.models_torch import ResidualFFNN
import time
...
def train_and_save_model(save_dir, X_tensor, y_svd, i):
    ...
    for _ in range(EPOCH):
        ...
        # 500번마다 loss 출력
        if (_ + 1) % 500 == 0:
            print(f"[Epoch {_+1}/{EPOCH}] Loss: {loss.item():.4f}")
