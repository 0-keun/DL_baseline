...
def save_loss_plot(history, loss_filename='loss', time_flag=False):
    """
    ...
    """
    loss_filepath = name_to_dir(name='graph',time_flag=time_flag)+name_time(default_name=loss_filename,ext='.png')
    plt.figure()
...
def save_acc_plot(history, acc_filename='accuracy', time_flag=False):
    '''
    ...
    '''
    acc_filepath = name_to_dir(name='graph',time_flag=time_flag)+name_time(default_name=acc_filename,ext='.png')
