...
def draw_single_subplot_for_prop(time, data_1, data_2, data_3, data_4, data_5, title):
    plt.figure(figsize=(15, 7))
    plt.rc('font',size=20)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    ...
    plt.plot(time, data_4, label='Proposed v3', color='crimson', linewidth=4)

    # plt.plot(time, data_5, label='Proposed (Final)', color='crimson', linewidth=7.5)
